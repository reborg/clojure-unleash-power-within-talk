;; Stuart Sierra
(ns notifying-promise
  (:refer-clojure :exclude [future promise deliver future-call])
  (:import [java.util.concurrent
            CountDownLatch Executor Future TimeUnit
...
(defmethod print-method clojure.lang.IDeref [o ^java.io.Writer w]
  (#'clojure.core/print-sequential (format "#<%s@%x%s: "
                            ...
                            (if (or (and (instance? clojure.lang.Agent o)
                              ...
                              " FAILED"
                              ""))
                    #'clojure.core/pr-on, "", ">", (list (if (and (instance? clojure.lang.IPending o) (not (.isRealized o)))
                                            :pending
